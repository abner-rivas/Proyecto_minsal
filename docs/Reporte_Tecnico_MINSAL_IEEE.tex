...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.8\linewidth]{../docs/curva_roc_final.png}
\caption{Curva ROC del modelo XGBoost optimizado para la detección de riesgo en salud mental. El AUC obtenido es 0.87.}
\label{fig:roc}
\end{figure}
